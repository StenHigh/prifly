...
//go:embed neutral-start.schema.json
var neutralStartPublicContracts []byte

//go:embed timed-session.schema.json
var timedSessionPublicContracts []byte

//go:embed routed-session.schema.json
var routedSessionPublicContracts []byte

//go:embed effects-session.schema.json
var effectsSessionPublicContracts []byte

//go:embed materialized-session.schema.json
var materializedSessionPublicContracts []byte

//go:embed stage-work.schema.json
var stageWorkPublicContracts []byte
...
//go:embed model-profile.schema.json
var modelProfilePublicContracts []byte

//go:embed profile-translation.schema.json
var profileTranslationPublicContracts []byte
