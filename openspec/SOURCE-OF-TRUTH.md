...
| Канонический AI Factory workflow | `openspec/specs/aif-classic-workflow/spec.md` | Новая capability; source set установлен в `harden-aif-classic-gate-routing` | `aif-classic-workflow` |
