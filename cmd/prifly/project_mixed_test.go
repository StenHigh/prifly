...
`)
	...
	if timed {
		if run.SchemaVersion != prifly.CoreEffectsStateVersion || task.SchemaVersion != prifly.AssistedSessionRoutedVersion || task.Delivery == nil || task.Delivery.Timing.RemainingMS != 3600000 {
