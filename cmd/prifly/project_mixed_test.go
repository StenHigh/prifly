...
`)
	...
	if timed {
		if run.SchemaVersion != prifly.CoreMaterializedStateVersion || task.SchemaVersion != prifly.AssistedSessionRoutedVersion || task.Delivery == nil || task.Delivery.Timing.RemainingMS != 3600000 {
