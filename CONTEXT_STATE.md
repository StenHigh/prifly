...
- `make-project-launch-workflow-neutral` — 21/24; закрыты 4.1, 4.2, 4.4, 4.5
  (внешние ворота AIF прогнаны против выпущенного кандидата, пакет `v1.11.0`
  `9ecb72d`). Открыты 3.5 и 4.3 — живые наблюдения UI и живой AIF pilot; 5.1 —
  стоящее обязательство адресных тестов.
